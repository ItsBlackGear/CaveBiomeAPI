...
public class GlobalBiomeFeatures {
    public boolean shouldGenerate(BiomeLoadingEvent event) {
        return event.getCategory() != Biome.Category.NETHER && event.getCategory() != Biome.Category.THEEND && event.getCategory() != Biome.Category.OCEAN && event.getCategory() != Biome.Category.NONE;
    }
    ...
    public void onBiomeLoad(BiomeLoadingEvent event) {
        ...
        if (CaveConfig.hasNoiseCarvers.get() && shouldGenerate(event)) {
