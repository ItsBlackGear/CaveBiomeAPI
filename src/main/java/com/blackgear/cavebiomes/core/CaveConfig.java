...
@Mod.EventBusSubscriber(modid = CavesAPI.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class CaveConfig {
    private static final ForgeConfigSpec.Builder COMMON_BUILDER = new ForgeConfigSpec.Builder();
    public static final ForgeConfigSpec COMMON_CONFIG;

    public static final ForgeConfigSpec.IntValue CAVE_BIOME_SIZE;
    public static final ForgeConfigSpec.BooleanValue shouldGenerateCaveBiomes;
    ...
    static {
        ...
        shouldGenerateCaveBiomes = COMMON_BUILDER.comment("determines if cave biomes generate naturally.").define("hasCaveBiomes", true);
