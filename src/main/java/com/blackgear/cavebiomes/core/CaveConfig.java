...
public class CaveConfig {
    ...
    static {
        ...
        caveBiomeSize   = COMMON_BUILDER.comment("determines the size of cave biomes globally.", "Default: 4, Amplified: 6").defineInRange("caveBiomeSize", 4, 1, 10);
        ...
        hasDefaultCave  = COMMON_BUILDER.comment("determines if default cave biome should generate in the world", "Note: to disable ALL the biomes use hasCaveBiomes instead, don't disable all biomes manually or you will break something").define("hasDefaultCaveBiome", true);
